...
static NI_ITEM items[NIT_NUMBER] = {
  ...
  { "Leader", NIT_LEADER,
      ...
      NI_PLAYER | NI_GOD,
      1, LEADERLTH, 0, ni_instr, ni_outstr, {0} },
  { "Race", NIT_RACE,
      ...
      NI_GOD,
      1, RACE_NUMBER - 1, 1, ni_cycle, ni_special, {0} },
  { "Alignment", NIT_ALIGN,
      ...
      NI_GOD,
      0, ALIGN_EVIL, 1, ni_cycle, ni_special, {0} },
  { "Class", NIT_CLASS,
  ...
  { "Aggression", NIT_AGGRESS,
      ...
      NI_GOD | NI_PLAYER,
      0, ACT_NUMBER - 1, 1, ni_cycle, ni_special, {0} },
  ...
  { "Login", NIT_LOGIN,
      ...
      NI_GOD | NI_GODSEE,
      0, NAMELTH, 1, ni_instr, ni_outstr, {0} },

  /* blank line here */
  { "", NIT_BLANK, "", "", "", NI_EMPTY, 0, 0, 0, ni_ignore, ni_ignore, {0} },
  ...
  { "Ship Holds", NIT_SHIPS,
      ...
      "", "", 0L, 0, 0, 0, ni_ignore, ni_outatt, {0} },
  { "Wagons", NIT_WAGONS,
  ...
  { "Center", NIT_CENTERCOORD,
      ...
      NI_GODSEE | NI_GOD,
      0, 0, 0, ni_incoord, ni_outcoord, {0} },
