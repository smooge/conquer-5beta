...
**Todo File**: `_modernization/memory/PERSISTENT_TODOS.md`
**Instruction for Next Session**: Load persistent todos and integrate with session-specific TodoWrite tool
**Update Workflow**: Edit persistent todo file during session, commit with session progress
