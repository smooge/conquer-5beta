...
Auxil/onavy.c:41:1: warning: old-style function definition [-Wold-style-definition]
   41 | get_cargo(str)
      | ^~~~~~~~~
Auxil/onavy.c: In function ‘loadstat’:
Auxil/onavy.c:93:1: warning: old-style function definition [-Wold-style-definition]
   93 | loadstat(status)
      | ^~~~~~~~
Auxil/onavy.c: In function ‘loadfleet’:
Auxil/onavy.c:168:20: error: implicit declaration of function ‘getselunit’; did you mean ‘geteuid’? [-Wimplicit-function-declaration]
  168 |         if((nvynum=getselunit()-MAXARM)>=0){
      |                    ^~~~~~~~~~
      |                    geteuid
Auxil/onavy.c:168:33: error: ‘MAXARM’ undeclared (first use in this function); did you mean ‘MAJ_FARM’?
  168 |         if((nvynum=getselunit()-MAXARM)>=0){
      |                                 ^~~~~~
      |                                 MAJ_FARM
Auxil/onavy.c:168:33: note: each undeclared identifier is reported only once for each function it appears in
Auxil/on
```
