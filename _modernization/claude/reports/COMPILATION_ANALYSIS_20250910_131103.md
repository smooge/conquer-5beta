...
Src/ioX.c:115:29: warning: unused parameter ‘sig’ [-Wunused-parameter]
  115 | win_size_change PARM_1(int, sig)
      |                        ~~~~~^~~
...
Src/ioX.c:1484:24: warning: comparison of integer expressions of different signedness: ‘size_t’ {aka ‘long unsigned int’} and ‘int’ [-Wsign-compare]
 1484 |     if (strlen(b
```
